...
function HomePage() {
  return (
    // 1. QUITAMOS "p-4" DE AQUÍ y agregamos "justify-between"
    <div
      className="relative min-h-screen bg-cover bg-center flex flex-col items-center justify-between text-gray-800"
      style={{ backgroundImage: `url(${BackgroundHome})` }}
    >
      {/* Capa semitransparente */}
      <div className="absolute inset-0 bg-white opacity-90 z-0"></div>

      {/* CONTENIDO PRINCIPAL (Logo, Título, Botones) */}
      {/* 2. AGREGAMOS "p-4" AQUÍ y "flex-grow" para que ocupe el espacio y empuje el footer */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center flex-grow w-full p-4">
      ...
      {/* --- FOOTER (Ahora sí tocará los bordes) --- */}
      <div className="relative z-10 w-full py-6 px-4 md:px-12 border-t border-gray-100/30 bg-white/40 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          {/* 2. Información de Contacto (Limpio) */}
